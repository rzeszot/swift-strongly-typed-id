...
final class IdentifierIntTests: XCTestCase {
    ...
    func test_StringConvertible() {
        let sut = Object.ID(12345)
        let result = "api/\(sut)/hello"
        XCTAssertEqual(result, "api/12345/hello")
    }
    ...
    struct Object: Codable {
        typealias ID = Identifier<Object, Int>
